...
function filteredByDesarrolloTag(entry){
  return _.includes(entry.tags, "Desarrollo")
}

const entradasByTagDesarrollo = _.filter(entries, filteredByDesarrolloTag)
//console.log(entradasByTagDesarrollo)

const entradasGrouppedByAuthor = _.groupBy(entradasByTagDesarrollo, "autor")
//console.log(entradasGrouppedByAuthor)

function mapeotitulo(entries){
  return _.map(entries, "titulo")
}

const entradasMappedByTitle = _.mapValues(entradasGrouppedByAuthor, mapeotitulo)
console.log(entradasMappedByTitle)
