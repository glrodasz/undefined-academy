...
function filtrarTagDesarrollo(entry){
  return _.includes.tag, "Desarrollo"}

const filtrarPorTagDesarrollo= _.filter(entries, filtrarTagDesarrollo)

const entradasPorAuthor = _.groupBy(filtrarPorTagDesarrollo, "autor")

function mapearPorTitulo(entries){
  return _.map(entries, "titulo") 
}
const entradaMapaPorTitulo = _.mapValues(entradasPorAuthor, mapearPorTitulo)
console.log(entradaMapaPorTitulo)
